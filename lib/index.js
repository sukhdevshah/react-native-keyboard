...
class Keyboard extends Component {
    ...
    _fullBorder(key) {
      ...
      switch (key) {
        ...
        case 'del':
        case '.':
          styles = { borderBottomWidth: hairlineWidth }
          break;
        case '.':
        case '1':
        case '4':
        case '7':
          styles = { borderLeftWidth: hairlineWidth }
          break;
        default:
          styles
      }
    ...
    _renderKey(key, index) {
        return (
            ...
            >
                <View style={[keyStyle.bd, this._fullBorder(key.mainText), this._disableBorder()]}>
    ...
    _renderDotKey() {
      if (this.props.disableDot !== true) {
        ...
        return (
            ...
            >
                <View style={[keyStyle.bd, this._fullBorder(dotText), this._disableBorder()]}>{dotNode}</View>
            </TouchableHighlight>
        );
      }
            ...
            <View style={styles.wrapper}>
                <View style={styles.main}>
                    ...
                    <View style={styles.row}>
                        ...
                        >
                            <View style={[keyStyle.bd, this._fullBorder('0'),  this._disableBorder()]}>
                        ...
                        >
                            <View style={[keyStyle.bd, this._fullBorder('del'), this._disableBorder()]}>
